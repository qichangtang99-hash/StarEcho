...
# ============================================================
# 启动弹窗（Splash Screen）— 仅首次加载显示
# ============================================================
if "splash_shown" not in st.session_state:
    st.session_state.splash_shown = True
    _splash_cover = _load_static_image("cover.png")
    _splash_logo = _load_static_image("logo.png")
    if _splash_cover:
        st.markdown(f"""
        <div class="splash-overlay">
            <div class="splash-box">
                <img src="{_splash_cover}" class="splash-image">
                <div class="splash-title">响星</div>
                <div class="splash-sub">AI 彩 铃 策 划</div>
...
# ============================================================
# 预加载Logo和功能图标为base64
_logo_url = _load_static_image("logo.png")
_icon_yinxing = _load_static_image("icons/01_引星自定_透明背景.png")
_icon_xingtu = _load_static_image("icons/02_星图不迷_透明背景.png")
_icon_liuxing = _load_static_image("icons/03_流星天降_透明背景.png")
_icon_anjiang = _load_static_image("icons/04_暗礁不触_透明背景.png")
_icon_xinghuo = _load_static_image("icons/05_星火点亮_透明背景.png")
_cover_url = _load_static_image("cover.png")

with st.sidebar:
    # Logo
    if _logo_url:
        st.markdown(f'<img src="{_logo_url}" class="sidebar-logo">', unsafe_allow_html=True)
    st.markdown("### 响星")
    ...
    for _icon_url, _func_name in _func_items:
        if _icon_url:
            st.markdown(f'<div style="display:flex;align-items:center;margin:0.3rem 0;"><img src="{_icon_url}" class="func-icon"><span style="color:#c8d8f0;font-size:0.9rem;">{_func_name}</span></div>', unsafe_allow_html=True)
        else:
...
# ============================================================
    ...
    with col1:
        # 引星插画
        _illust_yx = _load_static_image("illust_yinxing.png")
        st.markdown(f'''
        <div class="mode-card">
            <img src="{_illust_yx}" class="mode-illustration">
    ...
    with col2:
        # 星图插画
        _illust_xt = _load_static_image("illust_xingtu.png")
        st.markdown(f'''
        <div class="mode-card">
            <img src="{_illust_xt}" class="mode-illustration">
    ...
    with col3:
        # 流星插画
        _illust_lx = _load_static_image("illust_liuxing.png")
        st.markdown(f'''
        <div class="mode-card">
            <img src="{_illust_lx}" class="mode-illustration">
