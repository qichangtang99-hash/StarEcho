...
# DeepSeek API配置（优先级：Streamlit Secrets > 环境变量）
# 部署时在 Streamlit Cloud Settings → Secrets 中配置 DEEPSEEK_API_KEY
try:
...
API_KEY = _secret_key or os.environ.get("DEEPSEEK_API_KEY", "")
